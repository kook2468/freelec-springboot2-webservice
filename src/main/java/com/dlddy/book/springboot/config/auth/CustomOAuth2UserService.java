...
import com.dlddy.book.springboot.config.auth.dto.OAuthAttributes;
import com.dlddy.book.springboot.config.auth.dto.SessionUser;
import com.dlddy.book.springboot.domain.user.User;
import com.dlddy.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
         ...
         * 구글 기본 코드 : sub, 네이버 카카오 등은 기본 지원x
